...
from .views import AllTasksViewSetWithCheckPostData, MyBoardsView, RetrieveTasksInMyBoardView, RetrieveTaskInMyTasks, AllUsersViewSet, \
    AllBoardsViewSet, AllBoardsAndUsersViewSet, AllColumnsViewSet, AllBoardsAndColumnsViewSet

urlpatterns = [
    path('tasks/', AllTasksViewSetWithCheckPostData.as_view()),
